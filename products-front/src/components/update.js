...
import { Grid, FormControl, TextField, MenuItem, Select, InputLabel, FormLabel, RadioGroup, Radio, FormControlLabel } from '@material-ui/core';
      ...
      <div>
        <form className={classes.root} noValidate autocomplete='off'>
            <Grid container spacing={3}>
                <Grid item xs={4}>
                    <TextField id="filled-basic" variant='filled' label="Title" required value={title} onChange={(e) => setTitle(e.target.value)} />
                </Grid>
                <Grid item xs={4}>
            ...
            <TextField id="outlined-multiline-static" multiline row={10} style={{width:'850px'}} variant='filled' label='Description' value={description} onChange={(e) => setDescription(e.target.value)} />
